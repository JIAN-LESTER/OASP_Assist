...
// ✅ Update mobile layout to use Stack for overlay
Widget _buildMobileLayout(List<Widget> pages) {
  ...
  return Scaffold(
    ...
    // ✅ FIX: Wrap body in Stack to overlay loading screen
    body: Stack(
      children: [
...
Widget _buildTabletDesktopLayout(List<Widget> pages) {
  ...
  return GestureDetector(
    ...
    // ✅ FIX: Add tap to expand when collapsed
    onTap: () {
    ...
    child: AnimatedContainer(
      ...
      height: _isBottomNavExpanded ? 80 : 40, // ✅ Changed from 30 to 40
      child: Stack(
        ...
        children: [
          ...
          // ✅ FIX: Collapsed state with visible indicator
          if (!_isBottomNavExpanded)
            Container(
              height: 40,
              decoration: BoxDecoration(
