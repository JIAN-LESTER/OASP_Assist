...
class RoleDropdownButton extends StatefulWidget {
  ...
  const RoleDropdownButton({Key? key, this.initialValue, this.onChanged})
    : super(key: key);
...
class _RoleDropdownButtonState extends State<RoleDropdownButton> {
  String selectedValue = 'All Roles';

  final List<String> dropdownItems = ['All Roles', 'Admin', 'Staff', 'User'];
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        double width = isMobile ? double.infinity : (isTablet ? 140 : 150);
