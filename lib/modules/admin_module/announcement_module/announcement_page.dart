...
import 'package:capstone_project/modules/admin_module/announcement_module/announcement_card.dart';
import 'package:capstone_project/modules/admin_module/announcement_module/fb_storage.dart';

import 'package:capstone_project/modules/admin_module/announcement_module/token_input.dart';
...
class _AnnouncementPageState extends State<AnnouncementPage> {
  ...
  List<DocumentSnapshot> get filteredAnnouncements {
    var filtered = announcements.where((doc) {
      ...
      bool categoryMatches =
          ...
          normalizedDocCategory == _sentenceCase(normalizedSelectedCategory);
      ...
      if (_searchController.text.isNotEmpty) {
        ...
        return message.toLowerCase().contains(query) || message.contains(querySentence);
      }
      ...
      children: [
            ...
            Tooltip(
              ...
              child: Container(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    borderRadius: BorderRadius.circular(12),
                    onTap: () => showAppCredentialsDialog(context, fbHelper, () => setState(() {})),
                    child: Padding(
            ...
            if (fbHelper.configuredApps.isNotEmpty)
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [Colors.green[500]!, Colors.green[700]!]),
                    shape: BoxShape.circle,
        ...
        Stack(
          ...
          children: [
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      if (fbHelper.tokenStatus?.needsRenewal == true ||
                        ...
                        showTokenStatusDialog(context, fbHelper, () => setState(() {}));
                      } else {
                        showTokenInputModal(context, fbHelper, () => setState(() {}));
                      }
                    },
                    child: Padding(
                      padding: EdgeInsets.all(isDesktop ? 14 : 12),
            ...
            if (fbHelper.hasCheckedToken && fbHelper.tokenStatus?.configured == true)
              Positioned(
                top: -6,
                right: -6,
                child: GestureDetector(
                  onTap: () => showTokenStatusDialog(context, fbHelper, () => setState(() {})),
                  child: Container(
                    width: 18,
                    height: 18,
                    decoration: BoxDecoration(
                    ...
                    child: fbHelper.tokenStatus!.daysLeft != null &&
        ...
        Tooltip(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: (isRefreshing ? Colors.grey : Colors.green).withOpacity(0.3),
                  blurRadius: 8,
                  offset: Offset(0, 4),
                ),
              ],
      ...
      builder: (context, snapshot) {
        ...
        return RefreshIndicator(
          ...
          child: ListView.builder(
            padding: isDesktop ? const EdgeInsets.fromLTRB(32, 0, 32, 32) : EdgeInsets.zero,
            itemCount: displayedAnnouncements.length,
            itemBuilder: (context, index) {
              return Center(
                child: Container(
                  constraints: isDesktop ? const BoxConstraints(maxWidth: 1100) : null,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.timeline_rounded, color: Colors.green[700], size: 24),
                const SizedBox(width: 12),
                Text(
                  'Recent Activity',
                  style: TextStyle(
            ...
            child: Padding(
              ...
              child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView(
                    children: recentAnnouncements.map((doc) => _buildActivityItem(doc)).toList(),
                  );
                },
              ),
            ),
