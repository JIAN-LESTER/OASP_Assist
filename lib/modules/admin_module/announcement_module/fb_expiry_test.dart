...
class FacebookTokenTestingPanel extends StatefulWidget {
  ...
  @override
  State<FacebookTokenTestingPanel> createState() => _FacebookTokenTestingPanelState();
}
  ...
  Future<void> _triggerManualCheck() async {
    ...
    try {
      ...
      if (data['success'] == true) {
        setState(() {
          _lastTestResult = 'SUCCESS: ${data['message']}\n\n'
          ...
          children: [
            ...
            if (_tokenStatus != null) ...[
              Container(
                ...
                decoration: BoxDecoration(
                  color: _tokenStatus!['expired'] == true
                      ? Colors.red[50]
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  _isLoading ? 'Sending Test Notification...' : 'Send Test Notification',
            ...
            if (_lastTestResult != null) ...[
              ...
              Container(
                ...
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  color: _lastTestResult!.startsWith('SUCCESS')
                      ? Colors.green[50]
                      : Colors.red[50],
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
