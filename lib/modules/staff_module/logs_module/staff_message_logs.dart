...
import 'package:capstone_project/modules/admin_module/logs_module/log_info.dart';
import 'package:capstone_project/models/message_logs.dart';

import 'package:capstone_project/responsive/responsive_layout.dart';
import 'package:flutter/material.dart';

class StaffMessageLogsPage extends StatefulWidget {
  const StaffMessageLogsPage({super.key});

  @override
  State<StaffMessageLogsPage> createState() => _StaffMessageLogsPageState();
}

class _StaffMessageLogsPageState extends State<StaffMessageLogsPage> {
